          ...
          >
            <template v-slot:activator="{ on, attrs }">
              <v-btn
                ...
                v-bind="attrs"
                v-on="on"
                @click="$router.push(localePath('/projects/0'))"
              >
                {{$t('New_Item')}}
              </v-btn>
            </template>
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn
              ...
              v-bind="attrs"
              v-on="on"
              :to="localePath('/subscriptions/?project_id='+item.id)"
            >
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      this.$axios.$get('projects/?page_size='+itemsPerPage +'&page='+page+'&search=' + this.search)
        .then(response => {
    ...
    editItem (item) {
      ...
      this.$router.push(this.localePath('/projects/' + this.editedItem.id))
    },
